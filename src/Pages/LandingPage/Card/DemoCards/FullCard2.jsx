...
import L1 from "../../../../assets/images/Libraries/4.jpg";

import L2 from "../../../../assets/images/Libraries/5.jpg";
import L3 from "../../../../assets/images/Libraries/6.jpg";
import L4 from "../../../../assets/images/Libraries/7.jpg";
      ...
      <div className="flex flex-col rounded-2xl  overflow-hidden md:w-2xl">
        ...
        <div className="flex flex-col justify-between p-4 md:w-3xl w-full">
          ...
          <div className="mt-2   md:hidden">
            ...
            <p className="text-gray-600 mt-1">DumDuma</p>
          </div>
        </div>
      </div>
        ...
        <div className="flex ">
          <div className="w-[60%] p-4 space-y-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-sm text-gray-600">4,248 Reviews</div>
            </div>
          ...
          <div className="w-[50%] p-4 text-right space-y-2 ">
            <p className="text-gray-500 line-through text-sm">₹2,400/month</p>
            <p className="text-xl font-semibold text-green-700">₹1999/month</p>
