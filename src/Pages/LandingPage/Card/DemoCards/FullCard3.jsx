      ...
      <div className="flex flex-col rounded-2xl  overflow-hidden md:w-2xl">
        ...
        <div className="flex flex-col justify-between p-4 md:w-3xl w-full">
          ...
          <div className="mt-2   md:hidden">
            ...
            <p className="text-gray-600 mt-1">Patia</p>
          </div>
        </div>
      </div>
        ...
        <div className="flex ">
          <div className="w-[60%] p-4 space-y-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-sm text-gray-600">1,042 Reviews</div>
            </div>
          ...
          <div className="w-[50%] p-4 text-right space-y-2 ">
            <p className="text-gray-500 line-through text-sm">₹700/month</p>
            <p className="text-xl font-semibold text-green-700">₹499/month</p>
            <p className="text-sm text-gray-600">+ 0 Registration Fees</p>
