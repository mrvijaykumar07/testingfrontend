...
import L1 from "../../../../assets/images/Libraries/8.jpg";
import L2 from "../../../../assets/images/Libraries/9.jpg";
import L3 from "../../../../assets/images/Libraries/6.jpg";
import L4 from "../../../../assets/images/Libraries/10.jpg";
      ...
      <div className="flex flex-col rounded-2xl  overflow-hidden md:w-2xl">
        ...
        <div className="flex flex-col justify-between p-4 md:w-3xl w-full">
          <div className="flex  ">
            ...
            <div className="flex  md:w-fit items-center text-[rgb(100,122,151)] bg-gradient-to-b from-[rgb(239,245,251)] to-[rgb(255,255,255)] px-[2px] py-[6px] rounded">
              <div className="text-sm">
                <b>Get ₹300</b> off on <b>Flat 15% off</b>
              </div>
            </div>
          </div>
          ...
          <div className="mt-2   md:hidden">
            ...
            <p className="text-gray-600 mt-1">jaydev Bihar</p>
          </div>
        </div>
      </div>
        ...
        <div className="flex ">
          <div className="w-[60%] p-4 space-y-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-sm text-gray-600">408 Reviews</div>
            </div>
          ...
          <div className="w-[50%] p-4 text-right space-y-2 ">
            <p className="text-gray-500 line-through text-sm">₹1000/month</p>
            <p className="text-xl font-semibold text-green-700">₹700/month</p>
